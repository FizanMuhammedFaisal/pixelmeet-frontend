...
import { Users, Video, MessageSquare, Calendar, Zap, Globe, ArrowRight } from 'lucide-react'
...
const additionalFeatures = [
   {
      ...
      description: 'AI-powered meeting coordination that works across time zones and preferences',
   },
   {
      icon: Zap,
      title: 'Instant Interactions',
      description: 'Zero-latency communication with crystal-clear spatial audio technology',
   },
   {
      icon: Globe,
      title: 'Global Presence',
      description: 'Seamless collaboration experience for distributed teams worldwide',
   },
]
         ...
         <div className="container mx-auto px-4">
            ...
            >
               ...
               <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  PixelMeet recreates the spontaneous interactions and collaborative energy of a
                  physical office in a beautifully designed virtual environment.
               </p>
            </motion.div>
