...
export type SendPasswordResetTokenCredentials = z.infer<typeof SendPasswordResetTokenSchema>
export const VerifyPasswordResetTokenSchema = {
   token: z.string(),
   email: z.email(),
}
export type VerifyPasswordResetTokenCredentials = z.infer<typeof VerifyPasswordResetTokenSchema>
