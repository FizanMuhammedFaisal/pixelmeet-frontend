    ...
    <div className="flex flex-1 flex-col gap-6 p-4 pt-0 md:p-6 md:pt-0">
      ...
      >
        {maps.length > 0 ? (
            ...
            >
              <Card className="h-full flex flex-col overflow-hidden rounded-xl shadow-lg transition-all duration-300 hover:border-primary hover:ring-2 hover:ring-primary/50">
                <CardHeader className="p-5 pb-0">
                  <CardTitle className="text-xl font-bold leading-tight">{map.name}</CardTitle>
                </CardHeader>
          ...
          <div className="col-span-full flex h-64 items-center justify-center rounded-xl bg-muted/50 text-muted-foreground shadow-inner">
            Loading maps or no maps available...
          </div>
        )}
      </motion.div>
    </div>
