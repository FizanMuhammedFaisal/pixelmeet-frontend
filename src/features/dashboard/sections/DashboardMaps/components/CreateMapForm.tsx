      ...
      createMapMutation.mutate(
        {
          ...
          previewImageUrl: presignedRes.data.data.url,
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Categorize your map for easier discovery.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 shadow-sm flex-1">
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <FormDescription>Allow other users to view and use this map.</FormDescription>
                    </div>
                    <FormMessage />
                  </FormItem>
                )}
