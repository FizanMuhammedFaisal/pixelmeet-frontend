...
export function OverviewStats({ assets }: OverviewStatsProps) {
   ...
   const totalUsage = activeAssets.reduce((acc, asset) => acc + (asset.usageCount || 0), 0)
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
         ...
         <Card>
            ...
            <CardContent>
               ...
               <p className="text-xs text-muted-foreground">Combined size of all assets</p>
            </CardContent>
         </Card>
         ...
         <Card>
            ...
            <CardContent>
               ...
               <p className="text-xs text-muted-foreground">Your most loved assets</p>
            </CardContent>
         </Card>
