   ...
   >
      <Zoom
         classDialog={cn(
            ...
            // Crucially, add rounded-lg and object-cover to the modal image itself
            '[&_[data-rmiz-modal-img]]:absolute [&_[data-rmiz-modal-img]]:origin-top-left [&_[data-rmiz-modal-img]]:cursor-zoom-out [&_[data-rmiz-modal-img]]:transition-transform [&_[data-rmiz-modal-img]]:rounded-lg [&_[data-rmiz-modal-img]]:object-cover',
